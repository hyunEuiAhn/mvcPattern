...
<table border="1" cellpadding="5" cellspacing = "0">
  <tr>
   ...
   <td><input type = "text" size ="7" name = "name" placeholder="이름입력" value="<%=name%>">
   </td>
  </tr>
  
  <tr>
   <td align ="center">* 아이디</td>
   <td><input type ="text" size ="10" name ="id" readonly="readonly" value="<%=id%>">
   </td>
  </tr>
  ...
  <tr>
   ...
   <td><input type = "text" size ="12" name="email1" value="<%=email1%>">@
...
window.onload=function(){
	...
	document.getElementById("myEmail2").value = '<%=email2%>';	//<>모든테그의 최상위 element
	//document.modifyForm.tel1.value='<%=tel1%>';
	document.getElementById("mytel1").value='<%=tel1%>';
}
